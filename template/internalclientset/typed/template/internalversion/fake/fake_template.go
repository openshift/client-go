...
func (c *FakeTemplates) Create(template *template.Template) (result *template.Template, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(templatesResource, c.ns, template), &template.Template{})
...
func (c *FakeTemplates) Update(template *template.Template) (result *template.Template, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(templatesResource, c.ns, template), &template.Template{})
