...
// ProjectHelmChartRepositoryApplyConfiguration represents an declarative configuration of the ProjectHelmChartRepository type for use
// with apply.
...
// ProjectHelmChartRepository constructs an declarative configuration of the ProjectHelmChartRepository type for use with
// apply.
func ProjectHelmChartRepository(name, namespace string) *ProjectHelmChartRepositoryApplyConfiguration {
	...
	b.WithKind("ProjectHelmChartRepository")
...
func extractProjectHelmChartRepository(projectHelmChartRepository *helmv1beta1.ProjectHelmChartRepository, fieldManager string, subresource string) (*ProjectHelmChartRepositoryApplyConfiguration, error) {
	...
	b.WithName(projectHelmChartRepository.Name)
	b.WithNamespace(projectHelmChartRepository.Namespace)
...
func (b *ProjectHelmChartRepositoryApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
