...
func (b *ProjectHelmChartRepositoryApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *ProjectHelmChartRepositoryApplyConfiguration) GetAPIVersion() *string {
...
func (b *ProjectHelmChartRepositoryApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
