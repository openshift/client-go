...
type RangeAllocationIndexInformer cache.TypedSharedIndexInformer[*apisecurityinternalv1.RangeAllocation]

// RangeAllocationHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for RangeAllocation.
type RangeAllocationHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apisecurityinternalv1.RangeAllocation]
...
type RangeAllocationDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apisecurityinternalv1.RangeAllocation]

// RangeAllocationFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for RangeAllocation.
type RangeAllocationFilteringHandler = cache.TypedFilteringResourceEventHandler[*apisecurityinternalv1.RangeAllocation]

// RangeAllocationIndexers is a specialization of [cache.TypedIndexers] for RangeAllocation.
type RangeAllocationIndexers = cache.TypedIndexers[*apisecurityinternalv1.RangeAllocation]

// DeletedRangeAllocation is a specialization of [cache.DeletedObject] for RangeAllocation.
type DeletedRangeAllocation = cache.DeletedObject[*apisecurityinternalv1.RangeAllocation]
...
func NewTypedRangeAllocationInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) RangeAllocationIndexInformer {
	gvr := schema.GroupVersionResource{Group: "security.internal.openshift.io", Version: "v1", Resource: "rangeallocations"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apisecurityinternalv1.RangeAllocation](cache.NewSharedIndexInformerWithOptions(
...
func (f *rangeAllocationInformer) TypedInformer() RangeAllocationIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisecurityinternalv1.RangeAllocation](f.factory.InformerFor(&apisecurityinternalv1.RangeAllocation{}, f.defaultInformer))
}
...
func (a *rangeAllocationTypedInformerAdapter) TypedInformer() RangeAllocationIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisecurityinternalv1.RangeAllocation](a.Informer())
}
...
func ToRangeAllocationIndexInformer(informer cache.SharedIndexInformer) RangeAllocationIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apisecurityinternalv1.RangeAllocation](informer)
}
