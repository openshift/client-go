...
func RangeAllocation(name string) *RangeAllocationApplyConfiguration {
	...
	b.WithAPIVersion("security.internal.openshift.io/v1")
	return b
}
...
func ExtractRangeAllocationFrom(rangeAllocation *securityinternalv1.RangeAllocation, fieldManager string, subresource string) (*RangeAllocationApplyConfiguration, error) {
	b := &RangeAllocationApplyConfiguration{}
	err := managedfields.ExtractInto(rangeAllocation, internal.Parser().Type("com.github.openshift.api.securityinternal.v1.RangeAllocation"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractRangeAllocation(rangeAllocation *securityinternalv1.RangeAllocation, fieldManager string) (*RangeAllocationApplyConfiguration, error) {
