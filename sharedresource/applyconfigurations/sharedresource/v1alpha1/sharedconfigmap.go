...
func extractSharedConfigMap(sharedConfigMap *sharedresourcev1alpha1.SharedConfigMap, fieldManager string, subresource string) (*SharedConfigMapApplyConfiguration, error) {
	...
	b.WithName(sharedConfigMap.Name)
...
func (b *SharedConfigMapApplyConfiguration) WithOwnerReferences(values ...*v1.OwnerReferenceApplyConfiguration) *SharedConfigMapApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *SharedConfigMapApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *SharedConfigMapApplyConfiguration) WithSpec(value *SharedConfigMapSpecApplyConfiguration) *SharedConfigMapApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *SharedConfigMapApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *SharedConfigMapApplyConfiguration) GetAPIVersion() *string {
...
func (b *SharedConfigMapApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
