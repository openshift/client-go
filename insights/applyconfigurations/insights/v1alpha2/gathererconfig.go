...
type GathererConfigApplyConfiguration struct {
	...
	State *insightsv1alpha2.GathererState `json:"state,omitempty"`
}
...
func (b *GathererConfigApplyConfiguration) WithState(value insightsv1alpha2.GathererState) *GathererConfigApplyConfiguration {
	b.State = &value
	return b
}
