...
type GatherersApplyConfiguration struct {
	Mode   *insightsv1alpha2.GatheringMode `json:"mode,omitempty"`
...
func (b *GatherersApplyConfiguration) WithMode(value insightsv1alpha2.GatheringMode) *GatherersApplyConfiguration {
	b.Mode = &value
	return b
}
