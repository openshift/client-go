...
type HealthCheckApplyConfiguration struct {
	...
	TotalRisk   *insightsv1alpha2.TotalRisk `json:"totalRisk,omitempty"`
...
func (b *HealthCheckApplyConfiguration) WithTotalRisk(value insightsv1alpha2.TotalRisk) *HealthCheckApplyConfiguration {
	b.TotalRisk = &value
	return b
}
