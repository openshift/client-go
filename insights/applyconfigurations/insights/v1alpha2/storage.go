...
type StorageApplyConfiguration struct {
	Type             *insightsv1alpha2.StorageType             `json:"type,omitempty"`
...
func (b *StorageApplyConfiguration) WithType(value insightsv1alpha2.StorageType) *StorageApplyConfiguration {
	b.Type = &value
	return b
}
