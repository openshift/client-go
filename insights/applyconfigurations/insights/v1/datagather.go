...
func DataGather(name string) *DataGatherApplyConfiguration {
	...
	b.WithAPIVersion("insights.openshift.io/v1")
	return b
}
...
func ExtractDataGatherFrom(dataGather *insightsv1.DataGather, fieldManager string, subresource string) (*DataGatherApplyConfiguration, error) {
	b := &DataGatherApplyConfiguration{}
	err := managedfields.ExtractInto(dataGather, internal.Parser().Type("com.github.openshift.api.insights.v1.DataGather"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractDataGather(dataGather *insightsv1.DataGather, fieldManager string) (*DataGatherApplyConfiguration, error) {
...
func ExtractDataGatherStatus(dataGather *insightsv1.DataGather, fieldManager string) (*DataGatherApplyConfiguration, error) {
...
func (b *DataGatherApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *DataGatherApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *DataGatherApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *DataGatherApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *DataGatherApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *DataGatherApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *DataGatherApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *DataGatherApplyConfiguration) GetAPIVersion() *string {
...
func (b *DataGatherApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
