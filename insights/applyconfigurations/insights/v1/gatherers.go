...
type GatherersApplyConfiguration struct {
	Mode   *insightsv1.GatheringMode `json:"mode,omitempty"`
...
func (b *GatherersApplyConfiguration) WithMode(value insightsv1.GatheringMode) *GatherersApplyConfiguration {
	b.Mode = &value
	return b
}
