...
type StorageApplyConfiguration struct {
	Type             *insightsv1alpha1.StorageType             `json:"type,omitempty"`
...
func (b *StorageApplyConfiguration) WithType(value insightsv1alpha1.StorageType) *StorageApplyConfiguration {
	b.Type = &value
	return b
}
