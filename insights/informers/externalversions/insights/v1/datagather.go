...
type DataGatherIndexInformer cache.TypedSharedIndexInformer[*apiinsightsv1.DataGather]

// DataGatherHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for DataGather.
type DataGatherHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiinsightsv1.DataGather]

// DataGatherDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for DataGather.
type DataGatherDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiinsightsv1.DataGather]

// DataGatherFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for DataGather.
type DataGatherFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiinsightsv1.DataGather]

// DataGatherIndexers is a specialization of [cache.TypedIndexers] for DataGather.
type DataGatherIndexers = cache.TypedIndexers[*apiinsightsv1.DataGather]

// DeletedDataGather is a specialization of [cache.DeletedObject] for DataGather.
type DeletedDataGather = cache.DeletedObject[*apiinsightsv1.DataGather]
...
func NewTypedDataGatherInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) DataGatherIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiinsightsv1.DataGather](cache.NewSharedIndexInformerWithOptions(
...
func (f *dataGatherInformer) TypedInformer() DataGatherIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiinsightsv1.DataGather](f.factory.InformerFor(&apiinsightsv1.DataGather{}, f.defaultInformer))
}
...
func (a *dataGatherTypedInformerAdapter) TypedInformer() DataGatherIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiinsightsv1.DataGather](a.Informer())
}
...
func ToDataGatherIndexInformer(informer cache.SharedIndexInformer) DataGatherIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiinsightsv1.DataGather](informer)
}
