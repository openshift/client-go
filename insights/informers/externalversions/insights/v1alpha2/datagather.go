...
type DataGatherIndexInformer cache.TypedSharedIndexInformer[*apiinsightsv1alpha2.DataGather]

// DataGatherHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for DataGather.
type DataGatherHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiinsightsv1alpha2.DataGather]

// DataGatherDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for DataGather.
type DataGatherDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiinsightsv1alpha2.DataGather]

// DataGatherFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for DataGather.
type DataGatherFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiinsightsv1alpha2.DataGather]

// DataGatherIndexers is a specialization of [cache.TypedIndexers] for DataGather.
type DataGatherIndexers = cache.TypedIndexers[*apiinsightsv1alpha2.DataGather]

// DeletedDataGather is a specialization of [cache.DeletedObject] for DataGather.
type DeletedDataGather = cache.DeletedObject[*apiinsightsv1alpha2.DataGather]
...
func NewTypedDataGatherInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) DataGatherIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiinsightsv1alpha2.DataGather](cache.NewSharedIndexInformerWithOptions(
...
func (f *dataGatherInformer) TypedInformer() DataGatherIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiinsightsv1alpha2.DataGather](f.factory.InformerFor(&apiinsightsv1alpha2.DataGather{}, f.defaultInformer))
}
...
func (a *dataGatherTypedInformerAdapter) TypedInformer() DataGatherIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiinsightsv1alpha2.DataGather](a.Informer())
}
...
func ToDataGatherIndexInformer(informer cache.SharedIndexInformer) DataGatherIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiinsightsv1alpha2.DataGather](informer)
}
