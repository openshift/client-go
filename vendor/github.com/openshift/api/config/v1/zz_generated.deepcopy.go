...
func (in *FeatureCondition) DeepCopyInto(out *FeatureCondition) {
	*out = *in
	if in.OperatorConditions != nil {
		in, out := &in.OperatorConditions, &out.OperatorConditions
		*out = make(map[string]OperatorFeatureCondition, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
func (in *FeaturesStatus) DeepCopyInto(out *FeaturesStatus) {
	*out = *in
	if in.FeatureConditions != nil {
		in, out := &in.FeatureConditions, &out.FeatureConditions
		*out = make(map[string]FeatureCondition, len(*in))
		for key, val := range *in {
			newVal := new(FeatureCondition)
			val.DeepCopyInto(newVal)
			(*out)[key] = *newVal
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OperatorFeatureCondition) DeepCopyInto(out *OperatorFeatureCondition) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OperatorFeatureCondition.
func (in *OperatorFeatureCondition) DeepCopy() *OperatorFeatureCondition {
	if in == nil {
		return nil
	}
	out := new(OperatorFeatureCondition)
	in.DeepCopyInto(out)
	return out
}
