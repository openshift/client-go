...
import (
	...
	update "github.com/openshift/client-go/update/informers/externalversions/update"
...
func (f *sharedInformerFactory) Update() update.Interface {
	return update.New(f, f.namespace, f.tweakListOptions)
}
