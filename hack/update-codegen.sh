...
for group in apiserver apps authorization build config console image imageregistry network oauth project quota route samples security template user; do
