...
type IngressIndexInformer cache.TypedSharedIndexInformer[*apioperatorv1alpha1.Ingress]

// IngressHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for Ingress.
type IngressHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apioperatorv1alpha1.Ingress]

// IngressDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for Ingress.
type IngressDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apioperatorv1alpha1.Ingress]

// IngressFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for Ingress.
type IngressFilteringHandler = cache.TypedFilteringResourceEventHandler[*apioperatorv1alpha1.Ingress]

// IngressIndexers is a specialization of [cache.TypedIndexers] for Ingress.
type IngressIndexers = cache.TypedIndexers[*apioperatorv1alpha1.Ingress]

// DeletedIngress is a specialization of [cache.DeletedObject] for Ingress.
type DeletedIngress = cache.DeletedObject[*apioperatorv1alpha1.Ingress]
...
func NewTypedIngressInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) IngressIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apioperatorv1alpha1.Ingress](cache.NewSharedIndexInformerWithOptions(
...
func (f *ingressInformer) TypedInformer() IngressIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apioperatorv1alpha1.Ingress](f.factory.InformerFor(&apioperatorv1alpha1.Ingress{}, f.defaultInformer))
}
...
func (a *ingressTypedInformerAdapter) TypedInformer() IngressIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apioperatorv1alpha1.Ingress](a.Informer())
}
...
func ToIngressIndexInformer(informer cache.SharedIndexInformer) IngressIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apioperatorv1alpha1.Ingress](informer)
}
