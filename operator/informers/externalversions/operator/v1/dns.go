...
type DNSIndexInformer cache.TypedSharedIndexInformer[*apioperatorv1.DNS]

// DNSHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for DNS.
type DNSHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apioperatorv1.DNS]

// DNSDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for DNS.
type DNSDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apioperatorv1.DNS]

// DNSFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for DNS.
type DNSFilteringHandler = cache.TypedFilteringResourceEventHandler[*apioperatorv1.DNS]

// DNSIndexers is a specialization of [cache.TypedIndexers] for DNS.
type DNSIndexers = cache.TypedIndexers[*apioperatorv1.DNS]

// DeletedDNS is a specialization of [cache.DeletedObject] for DNS.
type DeletedDNS = cache.DeletedObject[*apioperatorv1.DNS]
...
func NewTypedDNSInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) DNSIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apioperatorv1.DNS](cache.NewSharedIndexInformerWithOptions(
...
func (f *dNSInformer) TypedInformer() DNSIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apioperatorv1.DNS](f.factory.InformerFor(&apioperatorv1.DNS{}, f.defaultInformer))
}
...
func (a *dNSTypedInformerAdapter) TypedInformer() DNSIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apioperatorv1.DNS](a.Informer())
}
...
func ToDNSIndexInformer(informer cache.SharedIndexInformer) DNSIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apioperatorv1.DNS](informer)
}
