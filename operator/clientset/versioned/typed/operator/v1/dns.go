...
func newDNSs(c *OperatorV1Client) *dNSs {
	return &dNSs{
		client: c.RESTClient(),
	}
}
...
func (c *dNSs) Get(name string, options metav1.GetOptions) (result *v1.DNS, err error) {
	result = &v1.DNS{}
	err = c.client.Get().
		Resource("dnss").
		Name(name).
...
func (c *dNSs) List(opts metav1.ListOptions) (result *v1.DNSList, err error) {
...
func (c *dNSs) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dNSs) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *dNSs) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
