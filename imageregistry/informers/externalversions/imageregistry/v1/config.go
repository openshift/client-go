...
type ConfigIndexInformer cache.TypedSharedIndexInformer[*apiimageregistryv1.Config]

// ConfigHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for Config.
type ConfigHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiimageregistryv1.Config]

// ConfigDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for Config.
type ConfigDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiimageregistryv1.Config]

// ConfigFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for Config.
type ConfigFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiimageregistryv1.Config]

// ConfigIndexers is a specialization of [cache.TypedIndexers] for Config.
type ConfigIndexers = cache.TypedIndexers[*apiimageregistryv1.Config]

// DeletedConfig is a specialization of [cache.DeletedObject] for Config.
type DeletedConfig = cache.DeletedObject[*apiimageregistryv1.Config]
...
func NewTypedConfigInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) ConfigIndexInformer {
	gvr := schema.GroupVersionResource{Group: "imageregistry.operator.openshift.io", Version: "v1", Resource: "configs"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apiimageregistryv1.Config](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ImageregistryV1().Configs().List(context.Background(), opts)
			},
			WatchFunc: func(opts metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ImageregistryV1().Configs().Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ImageregistryV1().Configs().List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ImageregistryV1().Configs().Watch(ctx, opts)
			},
		}, client),
...
func (f *configInformer) TypedInformer() ConfigIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiimageregistryv1.Config](f.factory.InformerFor(&apiimageregistryv1.Config{}, f.defaultInformer))
}
...
func (a *configTypedInformerAdapter) TypedInformer() ConfigIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiimageregistryv1.Config](a.Informer())
}
...
func ToConfigIndexInformer(informer cache.SharedIndexInformer) ConfigIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiimageregistryv1.Config](informer)
}
